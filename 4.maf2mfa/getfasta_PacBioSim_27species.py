...
if __name__ == '__main__':
    maf_files = ["/data/maf/dm6_PacBioSim_all.chr2L.maf",
                "/data/maf/dm6_PacBioSim_all.chr2R.maf",
                "/data/maf/dm6_PacBioSim_all.chr3L.maf",
                "/data/maf/dm6_PacBioSim_all.chr3R.maf",
                "/data/maf/dm6_PacBioSim_all.chr4.maf",
                "/data/maf/dm6_PacBioSim_all.chrX.maf",
                "/data/maf/dm6_PacBioSim_all.chrY.maf"]
    mafidx_files = ["/data/maf/dm6_PacBioSim_all.chr2L.mafidx",
                "/data/maf/dm6_PacBioSim_all.chr2R.mafidx",
                "/data/maf/dm6_PacBioSim_all.chr3L.mafidx",
                "/data/maf/dm6_PacBioSim_all.chr3R.mafidx",
                "/data/maf/dm6_PacBioSim_all.chr4.mafidx",
                "/data/maf/dm6_PacBioSim_all.chrX.mafidx",
                "/data/maf/dm6_PacBioSim_all.chrY.mafidx"]
    refsp = "dm6"
    ...
    splist = load_splist(maf_path="/data/maf/")
    bed_path="/data/dmel-all-r6.04.UTR5.12.bed"
    parse_bed(mafs_indexed, splist, bed_path,out_path="/results/dm6_PacBioSim_27species_5UTR.fa")
