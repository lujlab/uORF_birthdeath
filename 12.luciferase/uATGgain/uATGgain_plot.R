...
library(ggplot2)
library(ggpubr)
f=fread("/code/12.luciferase/uATGgain/uATGgain_protein.txt",header=T)
f$ratio=f$renilla/f$firefly
f$mut=factor(f$mut,levels=c("mel","sim"))

#qPCR result
q=fread("/code/12.luciferase/uATGgain/uATGgain_mRNA.txt",header=T)
...
wilcox.test(q_ct[q_ct$`5UTR`=="Mtpalpha"&q_ct$mut=="mel"&q_ct$treatment=="H2O",]$delta_ct,
            q_ct[q_ct$`5UTR`=="Mtpalpha"&q_ct$mut=="sim"&q_ct$treatment=="H2O",]$delta_ct)
wilcox.test(q_ct[q_ct$`5UTR`=="Manf"&q_ct$mut=="mel"&q_ct$treatment=="H2O",]$delta_ct,
            q_ct[q_ct$`5UTR`=="Manf"&q_ct$mut=="sim"&q_ct$treatment=="H2O",]$delta_ct)
wilcox.test(q_ct[q_ct$`5UTR`=="CG17163"&q_ct$mut=="mel"&q_ct$treatment=="H2O",]$delta_ct,
            q_ct[q_ct$`5UTR`=="CG17163"&q_ct$mut=="sim"&q_ct$treatment=="H2O",]$delta_ct)
...
wilcox.test(f3[f3$`5UTR`==i&f3$mut=="mel"&f3$treatment=="H2O",]$ratio3,
            f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="H2O",]$ratio3) #p-value = 0.04113
...
mean(f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="H2O",]$ratio3) #1.70287
mean(f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="NaAsO2",]$ratio3) #1.465267
...
p2=ggplot(f3[f3$`5UTR`==i,],aes(x=treatment,y=ratio3,fill=mut))+
  ...
  theme_classic()
wilcox.test(f3[f3$`5UTR`==i&f3$mut=="mel"&f3$treatment=="H2O",]$ratio3,
            f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="H2O",]$ratio3) #p-value =0.5887
wilcox.test(f3[f3$`5UTR`==i&f3$mut=="mel"&f3$treatment=="NaAsO2",]$ratio3,
            f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="NaAsO2",]$ratio3) #p-value =  0.1508
mean(f3[f3$`5UTR`==i&f3$mut=="mel"&f3$treatment=="H2O",]$ratio3)
mean(f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="H2O",]$ratio3) #0.958976
mean(f3[f3$`5UTR`==i&f3$mut=="mel"&f3$treatment=="NaAsO2",]$ratio3) #1
mean(f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="NaAsO2",]$ratio3) #1.396949
...
mean(f3[f3$`5UTR`==i&f3$mut=="mel"&f3$treatment=="H2O",]$ratio3)
mean(f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="H2O",]$ratio3) #3.495043
mean(f3[f3$`5UTR`==i&f3$mut=="sim"&f3$treatment=="NaAsO2",]$ratio3) #3.693001

pdf("/results/fig4abc.pdf",width=9,height=3)
