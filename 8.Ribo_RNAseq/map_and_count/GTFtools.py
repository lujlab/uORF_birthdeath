# -*- coding: utf-8 -*-
"""
GTF tools (flybase GTF) version 0.2

--------------------------------------------------------------
how to use this package --- include following lines:

    import sys
    sys.path.append("/home/zh/mysrc/")
    import GTFtools

# new standard:
    import importlib.machinery
    loader = importlib.machinery.SourceFileLoader('GTFtools', '/home/zh/mysrc/GTFtools.py')
    gtftools = loader.load_module()

    gtf_path = '/home/zh/database/flybase/dmel_r6.04_FB2015_01/dmel-all-r6.04.gtf'
    gtf = gtftools.GTFparse(gtf_path)
--------------------------------------------------------------
for python2.x: add following line before all non-comment lines
from __future__ import print_function

plan of version 0.1:
DONE: support bed format;
DNOE: print functions outside class;

--------------------------------------------------------------
change log:
    2015-1228: in utr5_bed12(), starts should -1 according bed format;
    2016-0214: added transcript_bed() to get bed annotation of transcript start and end;
    2016-0215: added cds_bed12() & cds_bed12_crop; import pdb for debug;

--------------------------------------------------------------
@author: zh (mt1022)
@date: Sun Aug  9 11:10:17 2015
"""
import sys
import re
import gzip
